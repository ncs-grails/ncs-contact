...
<html>
    <head>
        ...
        <title>Create AddressType</title>         
    </head>
    <body>
        <div class="nav">
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:addressTypeInstance,field:'name','errors')}">
                                    <input type="text" maxlength="30" id="name" name="name" value="${fieldValue(bean:addressTypeInstance,field:'name')}"/>
                                </td>
                            </tr> 
