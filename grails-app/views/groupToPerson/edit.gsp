...
<html>
    <head>
        ...
        <title>Edit GroupToPerson</title>
    </head>
    <body>
        <div class="nav">
        ...
        <div class="body">
            ...
            <g:form method="post" >
                ...
                <input type="hidden" name="version" value="${groupToPersonInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:groupToPersonInstance,field:'startDate','errors')}">
                                    <g:datePicker name="startDate" value="${groupToPersonInstance?.startDate}" noSelection="['':'']"></g:datePicker>
                                </td>
                            </tr> 
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:groupToPersonInstance,field:'endDate','errors')}">
                                    <g:datePicker name="endDate" value="${groupToPersonInstance?.endDate}" noSelection="['':'']"></g:datePicker>
                                </td>
                            </tr> 
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:groupToPersonInstance,field:'person','errors')}">
                                    <g:select optionKey="id" from="${Person.list()}" name="person.id" value="${groupToPersonInstance?.person?.id}" ></g:select>
                                </td>
                            </tr> 
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:groupToPersonInstance,field:'source','errors')}">
                                    <g:select name="source"
from="${Source.list()}"
size="5" multiple="yes" optionKey="id"
value="${groupToPersonInstance?.source}" />
